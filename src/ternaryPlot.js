/**
 * @typedef {import("./types").Barycentric} Barycentric
 * @typedef {import("./types").TernaryPlot} TernaryPlot
 * @typedef {import("./types").TernaryAxis} TernaryAxis
 * @typedef {import("./types").Coord} Coord
 */
